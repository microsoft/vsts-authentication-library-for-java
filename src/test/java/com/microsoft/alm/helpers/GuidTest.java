...
public class GuidTest {
    @Test
    public void fromBytes_allOnes() throws Exception {
        byte[] input =
                {
    ...
    @Test
    public void fromBytes_allZeroes() throws Exception {
        byte[] input =
                {
    ...
    @Test
    public void fromBytes_typical() throws Exception {
        byte[] input =
                {
    ...
    @Test
    public void toBytes_allOnes() throws Exception {
    ...
    @Test
    public void toBytes_allZeroes() throws Exception {
    ...
    @Test
    public void toBytes_typical() throws Exception {
    ...
    @Test
    public void tryParse_null() throws Exception {
